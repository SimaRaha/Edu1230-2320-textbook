...
1.2 Stata syntax and Naming conventions 1.3 Using the command prompt 1.3.1 Make students use it as a calculator 1.4 Loading data 1.4.1 Introduce an educational dataset – maybe OECD, NCES, open dataset Working Directory 1.4.2 Stata code count, describe, labels, etc. 1.5 Installing Packages 1.5.1 Give some examples to do 1.6 Tips and resources 1.6.1 Give some links to pages ---
